...
func SetupServer() {
   ...
   /  ___| /  _  \ |  _  \      /  ___/ | ____| |  _  \  | |   / / | | /  ___| | ____| 
   | |     | | | | | | | |      | |___  | |__   | |_| |  | |  / /  | | | |     | |__   
   | |  _  | | | | | | | |      \___  \ |  __|  |  _  /  | | / /   | | | |     |  __|  
   | |_| | | |_| | | |_| |       ___| | | |___  | | \ \  | |/ /    | | | |___  | |___  
   \_____/ \_____/ |_____/      /_____/ |_____| |_|  \_\ |___/     |_| \_____| |_____|  
		`
	...
	go func() {
		log.Printf("%s\n\n%s\n", banner, fmt.Sprintf("%s: Running at %s:%s", time.Now().Format("Mon, 02 Jan 2006 15:04:05 GMT"), host, port))
		// server connections
