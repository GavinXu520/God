...
CREATE TABLE `user_link` (
  ...
  `user_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '外建， 关联 user_account 的主键',
...
type UserLink struct {
	...
	SecondLinkName   string    `json:"second_link_name" gorm:"column:second_link_name;type:varchar(32);not null"`     //	用户次要联系人姓名
	SecondLinkMobile string    `gorm:"column:second_link_mobile;type:varchar(20);not null" json:"second_link_mobile"` //	用户次要联系人手机号码
...
type UserAccount struct {
	...
	Nick      string    `json:"nick" gorm:"column:nick;type:varchar(30);not null"`                //	昵称
...
type UserBase struct {
	ID         int       `gorm:"primary_key;column:id;type:bigint(20) unsigned;not null" json:"-"`  //	主键Id
	UserID     int64     `gorm:"column:user_id;type:bigint(20);not null" json:"user_id"`            //	外建， 关联 user_account 的主键
...
type UserCompany struct {
	...
	PhoneNo     string    `json:"phone_no" gorm:"column:phone_no;type:varchar(20);not null"`          //	办公电话
...
type UserLoginHistory struct {
	...
	LoginType  bool      `json:"login_type" gorm:"column:login_type;type:tinyint(1) unsigned;not null"` //	0:未知，1：password，2:手机验证码  3:第三方登陆
	TerminalID int       `gorm:"column:terminal_id;type:int(1);not null" json:"terminal_id"`            //	平台Id, 0: 未知平台; 1: 安卓; 2: IOS;
	Devicecode string    `gorm:"column:devicecode;type:varchar(50);not null" json:"devicecode"`         //	设备编码
	Version    string    `gorm:"column:version;type:varchar(10);not null" json:"version"`               //	设备版本号
	Longitude  string    `gorm:"column:longitude;type:varchar(10);not null" json:"longitude"`           //	gps 位置经度
...
type LoanInfo struct {
	ID         int       `gorm:"primary_key;column:id;type:bigint(20) unsigned;not null" json:"-"` //	主键Id
	UserID     int       `gorm:"column:user_id;type:bigint(20);not null" json:"user_id"`           //	外建， 关联 user_account 的主键
	LoanAmount int       `json:"loan_amount" gorm:"column:loan_amount;type:bigint(20);not null"`   //	借款的钱, 单位: 分?
	OpenAmount int       `gorm:"column:open_amount;type:bigint(20);not null" json:"open_amount"`   //	放款金额, 单位: 分?
	OpenTerm   int       `json:"open_term" gorm:"column:open_term;type:int(4);not null"`           //	放款周期
	CreatedAt  time.Time `gorm:"column:created_at;type:timestamp;not null" json:"created_at"`      //	创建时间
	UpdatedAt  time.Time `gorm:"column:updated_at;type:timestamp;not null" json:"updated_at"`      //	修改时间
	Status     int       `gorm:"column:status;type:tinyint(3) unsigned;not null" json:"status"`    //	状态
}
...
type OptionValueInfo struct {
	...
	OptionValue string    `json:"option_value" gorm:"column:option_value;type:text;not null"`                //	值
	CreatedAt   time.Time `gorm:"column:created_at;type:timestamp;not null" json:"created_at"`               //	创建时间
	UpdatedAt   time.Time `gorm:"column:updated_at;type:timestamp;not null" json:"updated_at"`               //	修改时间
	Status      int       `gorm:"column:status;type:tinyint(3) unsigned;not null" json:"status"`             //	状态
}
...
type UserAddr struct {
	...
	CreatedAt time.Time `gorm:"column:created_at;type:timestamp;not null" json:"created_at"`      //	创建时间
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamp;not null" json:"updated_at"`      //	修改时间
	Status    int       `json:"status" gorm:"column:status;type:tinyint(3) unsigned;not null"`    //	状态
}
