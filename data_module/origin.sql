...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='用户账户信息表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='用户主要信息表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='用户联系人表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='用户详细住址表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='用户公司认证表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='借款申请表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='用户注册信息表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='用户登陆历史表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='用户绑定第三方账号历史表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='用户修改密码历史表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='用户修改支付密码历史表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='公共选项值表';