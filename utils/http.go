...
func HttpGet(url string, params interface{}) (string, error) {
	...
	common.Logger.Info("HttpGet请求链接地址:", url, ",HttpGet请求参数为:", string(paramByte))
	...
	common.Logger.Info("HttpGet请求链接地址:", resp.Request.URL, ",HttpGet请求参数为:", string(paramByte), "HttpGet返回的结果是: ", body)
	return body, nil
}
...
func HttpPostForm(url string, params interface{}) (string, error) {
	...
	common.Logger.Info("HttpPostForm请求链接地址:", url, ",HttpPostForm请求参数为:", string(paramByte))
	request := gorequest.New()
	...
	common.Logger.Info("HttpPostForm请求链接地址:", resp.Request.URL, ",HttpPostForm请求参数为:", string(paramByte), ",HttpPostForm返回的结果是: ", body)
	return body, nil
}
...
func PostForm(url string, params interface{}) (string, error) {
	...
	common.Logger.Info("postForm请求链接地址:", url, ",postForm请求参数为:", string(paramByte))
	request := gorequest.New()
	...
	common.Logger.Info("postForm请求链接地址:", resp.Request.URL, ",postForm请求参数为:", string(paramByte), ",postForm返回的结果是: ", body)
	return body, nil
}
...
func HttpPostJson(url string, params interface{}) (string, error) {
	...
	common.Logger.Info("HttpPostJson请求链接地址:", url, ",HttpPostJson请求json参数为:", string(paramByte))
	request := gorequest.New()
	...
	common.Logger.Info("HttpPostJson请求链接地址:", resp.Request.URL, ",HttpPostJson请求json参数为:", string(paramByte), ",HttpPostJson返回的结果是: ", body)
	return body, nil
}
...
func HttpCustomMethod(method, url string, params interface{}) (string, error) {
	...
	common.Logger.Info("postJson请求链接地址:", url, ",postJson请求json参数为:", string(paramByte))
	request := gorequest.New()
	...
	common.Logger.Info("postJson请求链接地址:", resp.Request.URL, ",postJson请求json参数为:", string(paramByte), ",postJson返回的结果是: ", body)
	return body, nil
}
